...
class WriterEngine:
    ...
    def create_chapter(self, request: ChapterRequest, *, top_k: int = 8) -> GenerationResult:
        ...
        system = (
            ...
            "imitate or preserve source wording, syntax, redundancy, British usage, Victorian "
            "language, or Victorian style. Never reveal hidden reasoning. Return only the chapter "
            "prose. The result "
