...
SOURCE_MD = BUILD_DIR / "seneca_dialogues_v09_SOURCE.md"
OUTPUT_EPUB = BUILD_DIR / "seneca_dialogues_v09.epub"
REPORT_PATH = BUILD_DIR / "seneca_dialogues_v09_epub_report.json"
DOWNLOAD_DIR = Path("/home/periclesguara/Downloads/Dialogues\nSeneca")
DOWNLOAD_EPUB = DOWNLOAD_DIR / "seneca_dialogues_v09.epub"
DOWNLOAD_SOURCE = DOWNLOAD_DIR / "seneca_dialogues_v09_SOURCE.md"
DOWNLOAD_REPORT = DOWNLOAD_DIR / "seneca_dialogues_v09_epub_report.json"
...
def run_pandoc() -> dict[str, object]:
    ...
    css_path = BUILD_DIR / "epub_v09.css"
    css_path.write_text(
        "\n".join(
            [
                "body { margin: 0 4%; }",
...
def split_chapter_title_and_body_files(epub_path: Path) -> dict[str, object]:
    with tempfile.TemporaryDirectory(prefix="seneca_v09_split_") as tmp:
        workdir = Path(tmp)
