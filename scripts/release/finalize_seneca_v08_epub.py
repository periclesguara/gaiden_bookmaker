...
SOURCE_MD = BUILD_DIR / "seneca_dialogues_v08_SOURCE.md"
OUTPUT_EPUB = BUILD_DIR / "seneca_dialogues_v08.epub"
REPORT_PATH = BUILD_DIR / "seneca_dialogues_v08_epub_report.json"
DOWNLOAD_DIR = Path("/home/periclesguara/Downloads/Dialogues\nSeneca")
DOWNLOAD_EPUB = DOWNLOAD_DIR / "seneca_dialogues_v08.epub"
DOWNLOAD_SOURCE = DOWNLOAD_DIR / "seneca_dialogues_v08_SOURCE.md"
DOWNLOAD_REPORT = DOWNLOAD_DIR / "seneca_dialogues_v08_epub_report.json"
...
def run_pandoc() -> dict[str, object]:
    ...
    css_path = BUILD_DIR / "epub_v08.css"
    css_path.write_text(
        "\n".join(
            [
                "body { margin: 0 4%; }",
