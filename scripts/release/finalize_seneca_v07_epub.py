...
SOURCE_MD = BUILD_DIR / "seneca_dialogues_v07_SOURCE.md"
OUTPUT_EPUB = BUILD_DIR / "seneca_dialogues_v07.epub"
REPORT_PATH = BUILD_DIR / "seneca_dialogues_v07_epub_report.json"
DOWNLOAD_DIR = Path("/home/periclesguara/Downloads/Dialogues\nSeneca")
DOWNLOAD_EPUB = DOWNLOAD_DIR / "seneca_dialogues_v07.epub"
DOWNLOAD_SOURCE = DOWNLOAD_DIR / "seneca_dialogues_v07_SOURCE.md"
DOWNLOAD_REPORT = DOWNLOAD_DIR / "seneca_dialogues_v07_epub_report.json"
...
def body_for_epub(body: str) -> tuple[str, dict[str, object]]:
    ...
    for raw in body.splitlines():
        ...
        if CHAPTER_HEADING_RE.match(stripped):
            ...
            out.append(stripped)
            out.append("")
            out.append('<div class="chapter-title-pagebreak" aria-hidden="true"></div>')
            continue
...
def run_pandoc() -> dict[str, object]:
    ...
    css_path = BUILD_DIR / "epub_v07.css"
    css_path.write_text(
        "\n".join(
            [
                "body { margin: 0 4%; }",
                ...
                ".chapter-title-pagebreak { display: block; height: 0; page-break-before: always; break-before: page; }",
