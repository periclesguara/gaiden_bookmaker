"""Add the PR #18 Writer workflow after the existing manuscript history.

The operations are preserved from ``writer.0001_initial`` in PR #18
(``788a5842``). This stacked branch already has a different ``writer.0001``
and ``writer.0002``, so the verified operations must run as a forward migration.
"""
...
class Migration(migrations.Migration):
    dependencies = [("writer", "0002_writerpromotionevent_actor_and_more")]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sources",
                    models.ManyToManyField(blank=True, related_name="projects", to="writer.sourcedocument"),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=2500,
                        validators=[MinValueValidator(400), MaxValueValidator(12000)],
                    ),
                ),
                (
                    "session_count",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("COMPLETE", "Concluída"), ("FAILED", "Falhou")],
                        max_length=12,
                    ),
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                ...
                name="writer_unique_project_chapter",
            ),
        ),
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                ...
                name="writer_unique_chapter_session",
            ),
        ),
    ]
