...
urlpatterns = [
    ...
    path("batches/<int:batch_id>/reconcile/", views.batch_reconcile, name="batch_reconcile"),
    path(
    ...
    path(
        "<int:batch_id>/book-codes/preview/",
        views.batch_book_codes_preview,
        name="batch_book_codes_preview",
    ),
    path(
        "<int:batch_id>/book-codes/confirm/",
        views.batch_book_codes_confirm,
        name="batch_book_codes_confirm",
    ),
    path(
        "<int:batch_id>/book-codes/manifest/",
        views.batch_book_codes_manifest,
        name="batch_book_codes_manifest",
    ),
    ...
    path(
        "items/<int:item_id>/automated/",
        views.item_automated_preview,
        name="item_automated_preview",
    ),
    path(
        "items/<int:item_id>/automated/plan.json",
        views.item_automated_plan,
        name="item_automated_plan",
    ),
